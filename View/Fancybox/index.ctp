...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to View Image'); // the link which will trigger fancybox on click
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to View Gallery'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src4); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());		
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to View SWF'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src5); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());		
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to view Youtube Video'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src6); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());	

?>
<p>N.B. For youtube links, if you are not using the embed URL you may get  Error: Refused to display document because display forbidden by X-Frame-Options </p> 
</div>
<div id="vimeo">
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to view Vimeo Video'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src7); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());	
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to view Dailymotion Video'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src8); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());	
...
<?php
		  ...
		  $this->Fancybox->setPreviewContent('Click to view GoogleMap'); // the link which will trigger fancybox on click
		  $this->Fancybox->setMainContent($src9); // the content which will be shown in Fancybox
		  echo($this->Fancybox->output());	
